/**
 * KaosDebugPort — safe debug capabilities for the product runtime.
 *
...
/**
 * Editor binding health — structural type compatible with KaosQaDebugApi.
...
/**
 * Receipt snapshot — structural type compatible with KaosQaDebugApi.
 */
...
export interface KaosDebugPort {
