 ...
 *   Each device: "KAOS QA: Advance scenario step" → stepIndex: 1, label: "pre-action-baseline"
 *
 ...
 *   Each device: window.__KAOS_DEBUG__.__qaOnlyClearWitnessSuppressionUnsafe("QA-scratch/s12a-witness.md")
 *   Each device: window.__KAOS_DEBUG__.__qaOnlyTriggerWitnessDirtyUnsafe("QA-scratch/s12a-witness.md")
 *   Wait 5 seconds for stability window.
 *
 * STEP 6 — Advance to step 2 (all devices)
 *   Each device: "KAOS QA: Advance scenario step" → stepIndex: 2, label: "post-baseline-quorum"
 *
 ...
 *   Each device: "KAOS QA: Advance scenario step" → stepIndex: 3, label: "post-edit-convergence"
 *
 ...
 *   Each device: "KAOS QA: Export witness bundle"
