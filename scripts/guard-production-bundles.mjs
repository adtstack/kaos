 ...
 *                        Built with __KAOS_QA_HARNESS_ENABLED__=true.
 ...
 * gated behind __KAOS_QA_HARNESS_ENABLED__ (esbuild define, false in production).
...
const MAIN_FORBIDDEN = [
	...
	// Production builds use __KAOS_QA_HARNESS_ENABLED__=false (esbuild define),
