 ...
 * process env.
 * Uses a dedicated test vault ID unless KAOS_TEST_VAULT_ID is provided.
 */
...
const HOST = process.env.KAOS_TEST_HOST ?? envVars.KAOS_TEST_HOST ?? "http://127.0.0.1:8787";
const TOKEN = process.env.SYNC_TOKEN ?? envVars.SYNC_TOKEN ?? "";
const TEST_VAULT_ID =
	process.env.KAOS_TEST_VAULT_ID
	?? envVars.KAOS_TEST_VAULT_ID
