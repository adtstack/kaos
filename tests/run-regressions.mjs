...
const suites = [
	...
	[JITI, "tests/editor-workspace-orchestrator.ts"],
	...
	[JITI, "tests/attention-audit-and-retirement.ts"],
	...
	[JITI, "tests/device-auth-config.ts"],
	[JITI, "tests/device-auth-boundaries.ts"],
	...
	[JITI, "tests/qa-harness-conflict-assertion.ts"],
