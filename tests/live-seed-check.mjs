...
const room = process.env.KAOS_TEST_VAULT_ID;
const mode = process.env.KAOS_TEST_MODE ?? "seed";

if (!host || !token || !room) {
	throw new Error("KAOS_TEST_HOST, SYNC_TOKEN, and KAOS_TEST_VAULT_ID are required");
}
